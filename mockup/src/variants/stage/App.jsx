...
function StudioGlow() {
  ...
  return <div className="studio-glow" ref={ref} aria-hidden="true" />
}
...
function DeviceLaptop({ children, className = '', float = true }) {
  const reduce = useReducedMotion()
  return (
    <div className={`device-laptop ${float && !reduce ? 'is-floating' : ''} ${className}`}>
      <div className="device-laptop__lid">
        <div className="device-laptop__bezel">
          ...
          <div className="device-laptop__specular" aria-hidden="true" />
        </div>
      </div>
      <div className="device-laptop__base" aria-hidden="true">
        <div className="device-laptop__track" />
      </div>
      <div className="device-laptop__shadow" aria-hidden="true" />
    </div>
  )
}
  ...
  return (
    <div className="hero-screen" aria-hidden="true">
      ...
      <div className="hero-screen__body">
        ...
        <div className="hero-screen__main">
          <strong>Workflow graph</strong>
          <div className="hero-screen__nodes">
            <span>CRM</span>
            <span>Logic Apps</span>
            <span>Ops</span>
          </div>
          <div className="hero-screen__meters">
            <b style={{ width: '78%' }} />
            <b style={{ width: '54%' }} />
            <b style={{ width: '91%' }} />
          </div>
...
function Hero() {
  ...
  return (
    <section id="hero" className="hero">
      <div className="hero__studio" aria-hidden="true">
        <div className="hero__wash" />
        <div className="hero__rim" />
        <div className="hero__floor" />
      </div>

      <motion.div className="hero__device-plane" style={reduce ? undefined : { y, opacity }}>
        <DeviceLaptop>
          <HeroScreen />
        </DeviceLaptop>
      </motion.div>
        ...
        <div className="about-layout">
          ...
          <Reveal delay={0.08} className="about-copy">
            ...
            <aside id="hiring" className="recruiter-note" aria-labelledby="hiring-title" tabIndex={-1}>
              <p id="hiring-title" className="eyebrow">{about.recruiter.title}</p>
        ...
        <div className="services-layout">
          ...
          <div className="service-list" role="list">
            {services.items.map((item, i) => (
              <Reveal key={item.num} delay={i * 0.07} className="service-row" role="listitem">
...
function WorkScreen({ activeSpot, setActiveSpot }) {
  const project = work.project
  return (
    <div className="work-screen">
      <div className="work-screen__bar" aria-hidden="true">
        <i />
        <i />
        <i />
        <span>{project.urlLabel}</span>
      </div>
      <div className="work-screen__canvas">
        <div className="work-screen__demo" aria-hidden="true">
          <strong>
            solve my<span>PROBLEM</span>
          </strong>
          <p>Email marketing &amp; lead generation for growing businesses</p>
          <em>Get a Free Quote</em>
          <div className="work-screen__panels">
            <b />
            <b />
            <b />
          </div>
    ...
    <section id="work" className="work">
      <div className="section-shell">
        ...
        <div className="work-cinema">
          <Reveal className="work-device-wrap">
            <DeviceLaptop className="work-device" float>
              <WorkScreen activeSpot={activeSpot} setActiveSpot={setActiveSpot} />
            </DeviceLaptop>
          ...
          <Reveal delay={0.1} className="work-copy">
      ...
      <div className="section-shell">
        ...
        <div className="testimonial-rail">
          {testimonials.items.map((item, i) => (
            <Reveal key={item.name} delay={i * 0.07} className="testimonial">
              <p>“{item.quote}”</p>
              <footer>
...
<div className="mockup-banner">Redesign mockup · Stage</div>
    </>
  )
}
